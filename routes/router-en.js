        ...
        return recom(token).getGenresForArtists(artistIds).then(function(data2) {
            for (var index in data2.artists) {
                ...
                if(genre.indexOf("pop")>=0)
                    ...
                    genre = "funk"
                else if(genre.indexOf("indie")>=0)
                    genre = "indie"
                else if(genre.indexOf("country")>=0)
                    genre = "country"
                else if(genre.indexOf("metal")>=0)
                    genre = "metal"
                else if(genre.indexOf("house")>=0)
                    genre = "house"
                else if(genre.indexOf("classical")>=0)
                    genre = "classical"
                else if(genre.indexOf("rap")>=0)
                    genre = "rap"
                else if(genre.indexOf("folk")>=0)
                    genre = "folk"
                else if(genre.indexOf("r&b")>=0)
                    genre = "r&b"
