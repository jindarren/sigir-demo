...
if((navigator.language || navigator.browserLanguage).toLowerCase()!="en")
	alert("Sorry, currently the speech recognition of our system only supports English, please set your browser language to English. To set the browser language, you can go to the setting page and type 'language' in search bar.")
